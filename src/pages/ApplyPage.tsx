...
export default function ApplyPage() {
  ...
  const validateDateTime = () => {
    ...
    if (selectedDateTime <= buffer) {
      setValidationErrors(e => ({ ...e, datetime: 'Please select a date and time at least 5 minutes from now' }));
      return false;
    }
  ...
  return (
    <StudentLayout>
      <div className="max-w-2xl mx-auto">
        <div className="w-full space-y-6 rounded-lg border border-border bg-card p-6 shadow-sm">
